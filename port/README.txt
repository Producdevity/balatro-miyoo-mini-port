...
1. Extract the Roms folder to the root of an OnionOS SD card.
2. Copy your own Balatro.exe or Balatro.love into:

   Roms/PORTS/Games/Balatro/

   Keep its filename. Steam's Manage > Browse local files opens the game folder.
3. Refresh the OnionOS Ports list, then start Balatro from Strategy.
